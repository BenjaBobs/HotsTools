  ...
  talents: [
    ...
    [
      ...
      },
      {
        ...
        descriptionLong: "Activate to charge a short distance, dealing 275 (+4% / level) damage and Slowing enemies caught in the path by 60% for 1.25 second. After hitting an enemy Hero with Trample, reduce the cooldown of Azmodan's Heroic Ability by 25%.",
        cooldown: 20,
        category: "Talent",
        type: "Active",
    ...
    [
      ...
      },
      {
        ...
        descriptionLong: "All Shall Burn Slows enemy Heroes. While active, the target is Slowed by 15%, and if it lasts its full duration, they are Slowed by 50% for 2.5 seconds. If All Shall Burn's Channel kills or lasts its full duration against a Hero, reduce its cooldown by 50%.",
        cooldown: null,
        category: "Talent",
        type: "E",
        icon: "https://heroespatchnotes.github.io/heroes-talents/images/talents/storm_ui_icon_azmodan_allshallburn.png",
